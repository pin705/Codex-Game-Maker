# Asset Harness Prompt Contract: BOSS-001-thien-giac-move-side

Use this contract when generating the raw image sheet.

- Exact canvas: 1536x1024 pixels.
- Exact grid: 2 rows x 2 columns.
- Exact cell size: 768x512 pixels.
- Background: one flat solid chroma-key color #00FF00 across every cell.
- Safe zone per cell: x 72..696, y 72..440.
...
- Character foot/bottom baseline: keep grounded frames near y=430 inside each cell.
- Motion phases: 1: pose 1; 2: pose 2; 3: pose 3; 4: pose 4.
