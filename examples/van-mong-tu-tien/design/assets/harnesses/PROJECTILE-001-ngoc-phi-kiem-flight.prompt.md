# Asset Harness Prompt Contract: PROJECTILE-001-ngoc-phi-kiem-flight

Use this contract when generating the raw image sheet.

- Exact canvas: 1152x512 pixels.
- Exact grid: 2 rows x 3 columns.
- Exact cell size: 384x256 pixels.
- Background: one flat solid chroma-key color #FF00FF across every cell.
- Safe zone per cell: x 36..348, y 36..220.
...
- Motion phases: 1: pose 1; 2: pose 2; 3: pose 3; 4: pose 4; 5: pose 5; 6: pose 6.
